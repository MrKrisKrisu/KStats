...
abstract class FetchController extends Controller {
    ...
    private static function updateSession(User $user, Carbon $since): void {
    ...
    private static function legacyFetch(User $user): void {
        ...
        if(isset($nowPlaying->currently_playing_type)
           && ($nowPlaying->currently_playing_type === 'ad' || $nowPlaying->currently_playing_type === 'unknown')
        ) {
            echo '* Unsupported playing type. Skipping user.' . PHP_EOL;
            return;
        }
