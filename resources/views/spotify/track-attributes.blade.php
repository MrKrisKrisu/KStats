@if($track->popularity > 80)
    <label class="badge badge-sm bg-success" data-bs-toggle="tooltip" data-placement="top"
           title="{{__('spotify.trending.text')}}">
        <i class="fas fa-chart-line"></i> {{__('spotify.trending')}}
    </label>
@elseif($track->popularity > 60)
    <label class="badge badge-sm bg-primary" data-bs-toggle="tooltip" data-placement="top"
           title="{{__('spotify.popular.text')}}">
        <i class="far fa-thumbs-up"></i> {{__('spotify.popular')}}
    </label>
@elseif($track->popularity < 15)
    <label class="badge badge-sm bg-danger" data-bs-toggle="tooltip" data-placement="top"
