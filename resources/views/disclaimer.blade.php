...
@section('content')
    <main role="main" class="inner cover">
        <h1>Disclaimer</h1>
        <h2>TLDR / Kurzfassung</h2>
        <p>KStats ist ein privates Hobbyprojekt. Der Zweck von KStats ist es, Daten,
            die über bzw. vom User übermittelt werden analytisch auszuwerten.
            Die Daten werden nicht an Dritte weitergegeben. Alles bleibt bei mir/uns. KStats ist nicht
        ...
        <p>Sie können Ihren Browser so einstellen, dass Sie über das Setzen
            von Cookies informiert werden und Cookies nur im Einzelfall erlauben, die Annahme von
            Cookies für
        ...
        <p>Auf unseren Seiten sind Funktionen des Musik-
            ...
            Übersicht über die Spotify-PlugIns finden Sie unter <a href="https://developer.spotify.com"
                                                                   target="_blank">https://developer.spotify.com</a>
        </p>
        <p>Dadurch kann beim Besuch unserer Seiten
            über das Plugin eine direkte Verbindung zwischen Ihrem Browser und dem Spotify-Server
            hergestellt werden. Spotify erhält dadurch die Information, dass Sie mit Ihrer IP-Adresse
            unsere
            Seite besucht haben. Wenn Sie den Spotify Button anklicken während Sie in Ihrem
            Spotify-Account
            eingeloggt sind, können Sie die Inhalte unserer Seiten auf Ihrem Spotify Profil verlinken.
            Dadurch
            kann Spotify den Besuch unserer Seiten Ihrem Benutzerkonto zuordnen.</p>
        <p>Weitere Informationen
            hierzu finden Sie in der Datenschutzerklärung von Spotify: <a
