                ...
                <div class="card-body">
                    ...
                    @else
                        ...
                        <form method="POST">
                            ...
                            <button type="submit" name="btn" value="ka" class="btn btn-danger">{{__('general.idk')}}</button>
                        </form>
                    @endif
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    @else
                        ...
                        <form method="POST">
                            ...
                            <button type="submit" name="setVegetarian" value="1" class="btn btn-success">{{__('general.yes')}}</button>
                            <button type="submit" name="setVegetarian" value="0" class="btn btn-danger">{{__('general.no')}}</button>
                            <button type="submit" name="setVegetarian" value="-1" class="btn btn-dark">{{__('receipts.crowdsourcing.non_food')}}
                            </button>
                            <button type="submit" name="setVegetarian" value="ka" class="btn btn-warning">{{__('general.idk')}}
                            </button>
                        </form>
                    @endif
                </div>
